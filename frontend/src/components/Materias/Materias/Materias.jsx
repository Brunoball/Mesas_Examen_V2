...
const Materias = () => {
  ...
  const renderFiltrosGlobales = () => (
    <div className="mov-headFilters materias-headFilters materias-globalFilters materias-integratedFilters">
      <div className="mov-search materias-searchFilter materias-searchFilter--busqueda">

        <div className="materias-searchBox materias-searchBox--busqueda">
          <input
            id="materias-busqueda"
            className="cc-input cc-input--floating materias-searchInput materias-busquedaInput"
            type="text"
            value={valorBusqueda}
            onChange={(e) => setBusqueda(e.target.value)}
            placeholder="Buscar por materia, área, taller, curso o correlatividad"
          />
                  <span className="materias-filterTabs__label materias-searchLabel">
