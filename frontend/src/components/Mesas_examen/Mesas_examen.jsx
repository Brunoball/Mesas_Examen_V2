...
const MesasExamen = () => {
  ...
  const contenido = (
    <div className="mesas-page mov-page">
      <section
        className={`mesas-shell-card mesas-card-pdf-mode mesas-card-pdf-fijo mov-card mov-card--table ${tab !== "historial" ? "mesas-shell-card--tablas" : "mesas-shell-card--historial"} ${tab !== "historial" && totalCambiosDocentePendientes > 0 ? "mesas-shell-card--alerta-docente" : ""}`}
      >
