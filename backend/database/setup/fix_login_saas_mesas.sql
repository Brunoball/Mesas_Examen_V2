...
ON DUPLICATE KEY UPDATE nombre = VALUES(nombre), nivel = VALUES(nivel), activo = VALUES(activo);

INSERT INTO tenants (idTenant, nombre, logo_url, logo_icono_url, db_host, db_name, db_user, db_pass, idPlan, activo)
VALUES (1, 'Mesas Examen ENA', NULL, NULL, 'localhost', 'mesas_examen_ena', 'root', 'brunoball516', 1, 1)
...
INSERT INTO usuarios_master (idUsuarioMaster, idTenant, usuario, email_recuperacion, hash_contrasena, rol, tema, activo)
VALUES (1, 1, 'admin', NULL, '$2y$12$oX8KsPU5FT/K9.VFI2/gk.8s2M9D8i8fLedX2gIvUl8uYbmH0nHF6', 'admin', 'claro', 1)
ON DUPLICATE KEY UPDATE
  idTenant = VALUES(idTenant),
  hash_contrasena = VALUES(hash_contrasena),
  rol = VALUES(rol),
  tema = VALUES(tema),
  activo = VALUES(activo);

-- Si tu MySQL local NO tiene contraseña, ejecutá esta línea aparte:
-- UPDATE tenants SET db_pass = '' WHERE idTenant = 1;
