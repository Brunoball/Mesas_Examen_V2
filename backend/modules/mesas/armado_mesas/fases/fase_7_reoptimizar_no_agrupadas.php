...
function mesas_armado_reopt_completar_grupos_existentes(
    ...
    foreach ($pendientes as $numeroMesa => $numero) {
        ...
        foreach ($grupos as &$grupo) {
            ...
            if (!mesas_armado_reopt_numero_disponible_en_slot($numero, $fecha, $idTurno, $ocupacion, $bloqueosDocentes)) {
                continue;
            }
...
function mesas_armado_reopt_formar_grupos_con_anclas(
    ...
    foreach ($pendientes as $numeroMesa => $ancla) {
        ...
        if (!mesas_armado_reopt_numero_disponible_en_slot($ancla, $fecha, $idTurno, $ocupacionTemporal, $bloqueosDocentes)) {
            continue;
        }
        ...
        foreach ($pendientes as $candidatoMesa => $candidato) {
            ...
            if (!mesas_armado_reopt_numero_disponible_en_slot($candidato, $fecha, $idTurno, $ocupacionTemporal, $bloqueosDocentes)) {
                continue;
            }
    ...
    foreach ($grupos as $numeroGrupo => $grupo) {
        ...
        foreach (($grupo['numeros'] ?? []) as $donante) {
            ...
            foreach ($slots as $slot) {
                ...
                if (!mesas_armado_reopt_numero_disponible_en_slot($pendienteDestino, $fechaDestino, $turnoDestino, $ocupacionTemporal, $bloqueosDocentes)) {
                    continue;
                }

                mesas_armado_reopt_ocupar_numero($ocupacionTemporal, $pendienteDestino, $fechaDestino, $turnoDestino);

                if (!mesas_armado_reopt_numero_disponible_en_slot($donanteDestino, $fechaDestino, $turnoDestino, $ocupacionTemporal, $bloqueosDocentes)) {
                    continue;
                }
