<?php
// backend/modules/mesas/armado_mesas_docentes/fases/fase_5_validar_y_numerar.php
 ...
 */
function mesas_armado_docentes_fase_5_validar_y_numerar(): void
{
    try {
        $pdo = db();
        $body = request_body();
        ...
        log_error($e, 'mesas_armado_docentes_fase_5_validar_y_numerar');
